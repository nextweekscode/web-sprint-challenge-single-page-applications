...
returns the clostest route match in the component or its parents. primary use would be to construct nested paths.
you jcan use routematch to access a match without rendering a route, this is dont by passing it the location arugment


1. How would you explain form validation to someone who has never programmed before?
This is so we can test to make sure things are working properly, if you have ever filled out a form
and it told you it required something, this is form validation.


1. In 1-2 sentences, define end to end testing.
Helps to confirm that entire features work from the users perspective when using the actual application.
